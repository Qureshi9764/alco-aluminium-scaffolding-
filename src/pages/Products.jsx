        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {filteredProducts.map((product, index) => (
              ...
              >
                {/* Product Image */}
                <div className="aspect-video bg-gradient-to-br from-primary-100 to-accent-100 rounded-lg mb-6 -mx-6 -mt-6 relative overflow-hidden">
                  <div className="w-full h-full flex items-center justify-center">
                    <product.icon className="w-20 h-20 text-primary-600" />
                  </div>
